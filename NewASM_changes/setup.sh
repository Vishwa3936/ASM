...
sudo apt-get install -y --no-install-recommends \
    nmap masscan git curl wget unzip build-essential libpcap-dev ca-certificates \
...
for t in findomain "$SUB_DIR/bin/subdominator" dnsx httpx cdncheck naabu rustscan masscan nmap; do
    check "$t"
done
